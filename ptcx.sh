...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='peertube.conf'
CONFIGFOLDER='/root/.peertube'
COIN_DAEMON='/usr/local/bin/peertubed'
COIN_CLI='/usr/local/bin/peertube-cli'
COIN_REPO='https://www.dropbox.com/s/vefdztc0nffslro/ptcx.tar.gz'
COIN_NAME='PEERTUBECRYPTO'
COIN_PORT=3220
...
#Generating Random Password for peertubed RPC
rpcpassword=$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)



function compile_node() {
  echo -e "THIS SCRIPT IS CREATED BY TEAM PeerTubeCrypto"
...
function important_information() {
 ...
 echo -e "Check if $COIN_NAME is running by using the following command: ${RED}systemctl status PEERTUBECRYPTO.service${NC}"
 echo -e "================================================================================================================================"
}
